...
//		driver.manage().window().fullscreen();
		...
		// code to add the Explicite wait in Selenium 4.7.2
	...
	/* The Same above code is now working on chrome and  firefox browser after adding the Explicit Wait on specific element*/
